...
We'll imagine a scenario that features five people, each represented in our system by an `id` and a `postcode`. To improve our service, we want to learn more about where these people live.
